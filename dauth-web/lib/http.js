...
exports.Http = void 0;
var mergeOptions = function (defaultOptions, options) {
...
var Http = /** @class */ (function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, fetch(url, mergeOptions(defaultOptions, options))];
                    case 1:
                        response = _a.sent();
    ...
    Http.post = function (url, data, options) {
        if (data === void 0) { data = {}; }
        return __awaiter(this, void 0, void 0, function () {
            var formData, name_1, defaultOptions, response;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
